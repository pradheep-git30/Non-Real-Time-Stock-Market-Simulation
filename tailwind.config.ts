  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'text-glow': {
          '0%, 100%': {
            'text-shadow': '0 0 5px hsl(var(--primary) / 0.4)',
          },
          '50%': {
        ...
        'confetti-pan': {
          ...
          '100%': { 'background-position': '100% 100%', 'background-size': '200% 200%'},
        },
        'bounce-slow': {
      ...
      animation: {
        ...
        'slow-pan': 'slow-pan 50s ease-in-out infinite alternate',
        'tilt': 'tilt 10s infinite linear',
        'confetti-pan': 'confetti-pan 15s ease-in-out infinite alternate',
